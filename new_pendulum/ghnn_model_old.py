...
class GNN_maker_HNN(nn.Module):
    def __init__(self,g, in_dim,hid_dim, out_dim,acts,bias=True,type="GCN",dropout =0.65):
        super().__init__()
        self.g = g
        self.g_hnn=g
        modules = []
...
class rollout_GNN_GRU(nn.Module):
    def __init__(self,g,in_dim,hid,gnn_size,acts,bias=True,type="GCN",dropout=0.65):
        super().__init__()
